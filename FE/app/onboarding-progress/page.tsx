...
import { TrendingUp, AlertCircle, Calendar, Users, BarChart3, AlertTriangle, Home, Folder, Zap, CheckSquare, Target, Lock, Settings, X } from 'lucide-react';
  ...
  return (
    <div className={styles.container}>
      ...
      {isProgressDetailModalOpen && selectedNewbie && (
        <div className={styles.modalOverlay} onClick={() => setIsProgressDetailModalOpen(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h2>신입 상세 정보</h2>
              <button onClick={() => setIsProgressDetailModalOpen(false)} className={styles.modalCloseBtn}>
                <X size={20} />
              </button>
            </div>
            ...
            <div className={styles.modalFooter}>
              <button onClick={() => setIsProgressDetailModalOpen(false)} className={styles.cancelBtn}>
                닫기
              </button>
      ...
      {isOnboardingOverviewModalOpen && (
        <div className={styles.modalOverlay} onClick={() => setIsOnboardingOverviewModalOpen(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h2>인수인계 개요</h2>
              <button onClick={() => setIsOnboardingOverviewModalOpen(false)} className={styles.modalCloseBtn}>
                <X size={20} />
              </button>
            </div>
            ...
            <div className={styles.modalFooter}>
              <button onClick={() => setIsOnboardingOverviewModalOpen(false)} className={styles.cancelBtn}>
                닫기
              </button>
              <button className={styles.primaryBtn}>
                상세 분석 보기
      ...
      {isUserProgressModalOpen && (
        <div className={styles.modalOverlay} onClick={() => setIsUserProgressModalOpen(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h2>사용자별 진행도</h2>
              <button onClick={() => setIsUserProgressModalOpen(false)} className={styles.modalCloseBtn}>
                <X size={20} />
              </button>
            </div>
            ...
            <div className={styles.modalFooter}>
              <button onClick={() => setIsUserProgressModalOpen(false)} className={styles.cancelBtn}>
                닫기
              </button>
            </div>
          </div>
      ...
      {isTeamStatisticsModalOpen && (
        <div className={styles.modalOverlay} onClick={() => setIsTeamStatisticsModalOpen(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h2>팀 통계</h2>
              <button onClick={() => setIsTeamStatisticsModalOpen(false)} className={styles.modalCloseBtn}>
                <X size={20} />
              </button>
            </div>
            ...
            <div className={styles.modalFooter}>
              <button onClick={() => setIsTeamStatisticsModalOpen(false)} className={styles.cancelBtn}>
                닫기
              </button>
            </div>
          </div>
      ...
      {isProgressActionModalOpen && selectedNewbie && (
        <div className={styles.modalOverlay} onClick={() => setIsProgressActionModalOpen(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h2>진행도 조치</h2>
              <button onClick={() => setIsProgressActionModalOpen(false)} className={styles.modalCloseBtn}>
                <X size={20} />
              </button>
            </div>
            ...
            <div className={styles.modalFooter}>
              <button onClick={() => setIsProgressActionModalOpen(false)} className={styles.cancelBtn}>
                닫기
              </button>
            </div>
          </div>
