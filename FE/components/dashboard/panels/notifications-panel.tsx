  ...
  const notifications = [
    {
      ...
      message: '"[목업] 행사운영가이드.pdf 읽기" 마감이 30분 남았습니다.',
      time: '10:00',
      icon: Bell,
      unread: true,
    },
    {
      id: 2,
      title: '새 파일이 준비 완료 상태가 되었습니다',
      message: '[목업] 행사_예산안_v7.xlsx 파일이 준비 완료 상태가 되었습니다.',
      time: '09:45',
      icon: BarChart3,
      unread: true,
    },
    {
      id: 3,
      title: '인공지능 답변이 준비되었습니다',
      message: '"이 예산은 언제 사용합니까?" 질문에 대한 인공지능 답변이 준비되었습니다.',
      time: '09:30',
      icon: Sparkles,
      unread: true,
    },
    ...
    {
      id: 6,
      title: '인공지능 요약이 완료되었습니다',
      message: '[목업] 행사운영가이드.pdf 파일의 요약이 완료되었습니다.',
      time: '08:20',
      icon: MessageSquare,
      unread: false,
    },
