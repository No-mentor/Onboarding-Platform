...
const MOCK_DAILY_TASKS = {
  document: [
    { id: 1, name: '[목업] 행사운영가이드.pdf 읽기', type: 'pdf', status: 'done', time: '10:30까지', description: '추천 이유 · 오늘 선행 필요' },
    { id: 2, name: '[목업] 예산안_v7.xlsx 검토', type: 'excel', status: 'pending', time: '14:00까지', description: '예상 소요 · 20분' },
  ],
  checklist: [
    { id: 3, name: '신입 계정 권한 확인', type: 'checklist', status: 'done', time: '14:00까지', description: '추천 이유 · 오늘 선행 필요' },
    { id: 4, name: '주간회의 자료 준비', type: 'checklist', status: 'pending', time: '16:00까지', description: '예상 소요 · 20분' },
  ],
  practice: [
    { id: 5, name: '예산 샘플 업데이트', type: 'practice', status: 'done', time: '16:00까지', description: '추천 이유 · 오늘 선행 필요' },
    { id: 6, name: '거래처 정보 최신화', type: 'practice', status: 'pending', time: '17:00까지', description: '예상 소요 · 20분' },
  ],
};
      ...
      <main className={styles.main}>
        <div className={styles.header}>
          <div>
            ...
            <p className={styles.description}>인공지능이 30 일 계획과 현재 진행 상황을 바탕으로 오늘 해야 할 일을 추천합니다.</p>
          </div>
          ...
          <div className={styles.progressCard}>
            <div className={styles.progressHeader}>
              ...
              <div className={styles.statusBadges}>
                ...
                <div className={styles.badge} style={{ color: '#0765FC' }}>진행 {statusInfo.inProgress}</div>
